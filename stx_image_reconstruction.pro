FUNCTION  stx_image_reconstruct, path_bkg_file, path_sci_file, flare_start_UTC, flare_end_UTC, energy_range_science_channel_lower_limit, energy_range_science_channel_upper_limit, $
