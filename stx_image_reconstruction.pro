PRO  stx_image_reconstruct, path_bkg_file, path_sci_file, $
                            ...
                            energy_range_full_disk_bp_map_channel_lower_limit_keV, energy_range_full_disk_bp_map_channel_upper_limit_keV, $
  ...
  ;;***** Parameters
  energy_range = [energy_range_full_disk_bp_map_channel_lower_limit_keV,energy_range_full_disk_bp_map_channel_upper_limit_keV]
